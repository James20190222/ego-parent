                    ...
                    <tr>
                        ...
                        <td class="summary">
                            <table class="catlist" width="100%">
                                ...
                                <c:forEach items="${cartList.goodsVoList}" var="cart">
                                <tr>
                        ...
                        <td class="summary">
                            ...
                            <div class="f-r" style="width:170px;padding:0 15px;background:#f3f3f3;">
                                <form action="${ctx}/order/submitOrder" method="post">
                                    <input type="hidden" name="totalPrice" value="${cartList.totalPrice}">
                                <table class="totable" width="100%">

                                    <tr>
                                        <td>商品总价：</td>
                                        <td align="right">￥${cartList.totalPrice}</td>
                                    </tr>
                                    <tr>
                                        <td>运费金额：</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><strong
                                                style="font-size:18px;color:#dc0000;">￥${cartList.totalPrice}</strong></td>
                                    </tr>
                                    <tr>
