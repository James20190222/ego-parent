        ...
        <div class="form-group has-feedback">
            <opinioncontrol realtime="true" opinion_name="vertify_code" default="true">
                <div class="row" style="padding-right: 65px;">
                    <div class="col-xs-8">
                        <input style="width: 135px" type="text" id="vertify" name="vertify" class="form-control" placeholder="验证码"/>
                    </div>
                    <div class="col-xs-4">
...
<script>
    ...
    $("#imgVerify").on("click",function () {
        $("#imgVerify").attr("src","${ctx}/image/getKaptchaImage?time="+new Date());
    })
