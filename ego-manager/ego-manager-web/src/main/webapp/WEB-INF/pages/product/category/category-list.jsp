...
<head>
    ...
    <script type="text/javascript">
        function delfunc(obj,id) {
            layer.confirm('确认删除？', {
                    btn: ['确定', '取消'] //按钮
                }, function () {
                    $.ajax({
                        type: 'get',
                        url: "${ctx}/product/category/delete/"+id,
                        dataType: 'json',
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="list-table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tbody>
                                    <c:forEach items="${gcList}" var="gc1">
                                        <tr role="row" align="center" class="1" id="1_1">
                                            ...
                                            <span class="glyphicon glyphicon-plus btn-warning"
                                                  ...
                                                  onclick="rowClicked(this)"></span>&nbsp; <span>${gc1.name}</span>
                                            </td>
                                            <td><span>${gc1.mobileName}</span></td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text"
                                                       ...
                                                       value="${gc1.catGroup}" class="input-sm"/>
                                            </td>
                                            <td>
                                                <input type="text"
                                                       ...
                                                       onkeyup="this.value=this.value.replace(/[^\d]/g,'')"
                                                       onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4"
                                                       value="${gc1.sortOrder}" class="input-sm"/>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary" href="${ctx}/product/category/edit/${gc1.id}"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a class="btn btn-danger"
                                                   href="javascript:void(0);" onclick="delfunc(this,'${gc1.id}')"><i
                                                        class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                        <c:forEach items="${gc1.children}" var="gc2">
                                            ...
                                            <span class="glyphicon glyphicon-plus btn-warning"
                                                  ...
                                                  aria-hidden="false" onclick="rowClicked(this)"></span>&nbsp; <span>${gc2.name}</span>
                                                </td>
                                                <td><span>${gc2.mobileName}</span></td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text"
                                                           ...
                                                           onkeyup="this.value=this.value.replace(/[^\d]/g,'')"
                                                           onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4"
                                                           value="${gc2.catGroup}" class="input-sm"/>
                                                </td>
                                                <td>
                                                    <input type="text"
                                                           ...
                                                           onkeyup="this.value=this.value.replace(/[^\d]/g,'')"
                                                           onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4"
                                                           value="${gc2.sortOrder}" class="input-sm"/>
                                                </td>
                                                <td>
                                                    <a class="btn btn-primary"
                                                       href="${ctx}/product/category/edit/${gc2.id}"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a class="btn btn-danger"
                                                       href="javascript:void(0);" onclick="delfunc(this,'${gc2.id}')"><i
                                                            class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <c:forEach items="${gc2.children}" var="gc3">
                                                <tr role="row" align="center" class="3" id="3_100" style="display:none">
                                                    <td>${gc3.id}</td>
                                                    <td align="left" style="padding-left:15em">
                                                        <span>${gc3.name}</span>
                                                    </td>
                                                    <td><span>${gc3.mobileName}</span></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text"
                                                               ...
                                                               size="4"
                                                               value="${gc3.catGroup}" class="input-sm"/>
                                                    </td>
                                                    <td>
                                                        <input type="text"
                                                               ...
                                                               onpaste="this.value=this.value.replace(/[^\d]/g,'')"
                                                               size="4"
                                                               value="${gc3.sortOrder}" class="input-sm"/>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-primary"
                                                           href="${ctx}/product/category/edit/${gc3.id}"><i
                                                                class="fa fa-pencil"></i></a>
                                                        <a class="btn btn-danger"
                                                           href="javascript:void(0);" onclick="delfunc(this,'${gc3.id}')"><i
                                                                class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
