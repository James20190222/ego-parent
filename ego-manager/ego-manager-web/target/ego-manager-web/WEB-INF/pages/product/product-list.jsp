                    ...
                    <div class="navbar navbar-default">
                        <form  id="search-form2" class="navbar-form form-inline" method="post"
                            ...
                            <div class="form-group">
                                <select name="cat_id" id="cat_id" class="form-control" onchange="ajax_get_table(1)">
                                    <option value="">所有分类</option>
                                    <c:forEach items="${gcList}" var="goodsCategory">
                            ...
                            <div class="form-group">
                                ...
                                <select name="pageSize" id="pageSize" onchange="ajax_get_table(1)" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="goodsName" value="" placeholder="搜索词" id="goodsName"
                            ...
                            <button  onclick="ajax_get_table(1)"
                                    id="button-filter search-order" class="btn btn-primary"><i class="fa fa-search"></i>
                                筛选
                            </button>
                            <button type="button" onclick="location.href='${ctx}/product/add'"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width:150px;">操作</td>
                                    </tr>
                                    </thead>
...
<script type="template" id="goodsTemplate">
    ...
    <tr>
        ...
        <td class="text-center">
            ...
            <a href="product-add.jsp" class="btn btn-primary" title="编辑"><i
...
<script type="template" id="pageTemp">
    ...
    <li class="paginate_button previous">
        <a class="next"  href="javascript:viod(0)" onclick="ajax_get_table('{{=it.pageNum-1}}')">上一页</a>
    </li>
    {{}}}
    ...
    <li class="paginate_button
        ...
        {{}}}
        ">
        <a href="javascript:viod(0)" onclick="ajax_get_table('{{=i}}')">{{=i}}</a>
    </li>
    {{}}}
    {{if(it.hasNextPage){}}
    <li class="paginate_button next">
        <a class="next"  href="javascript:viod(0)" onclick="ajax_get_table('{{=it.pageNum+1}}')">下一页</a>
    </li>
    {{}}}
</script>
<script type="text/javascript">
