    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="pull-right">
                <a  id="back_a" href="${ctx}/product/spec/list/${typeId}" data-toggle="tooltip" title="" class="btn btn-default"
                ...
                <div class="panel-body">
                    ...
                    <form method="post" id="addEditSpecForm">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="typeId" id="typeId" type="text"/>
                                            <select name="typeId" id="type_id" onchange="getTypeName()">
                        ...
                        <div class="pull-right">
                            ...
                            <button id="submit_id" class="btn btn-primary" title="" data-toggle="tooltip" type="button"
...
<script type="text/javascript">
    ...
    $("#submit_id").on("click",function () {
        ...
        var list_url='${ctx}/product/spec/list/'+typeId;
        $("#back_a").attr("href",list_url);
        ajax_submit_form('addEditSpecForm','${ctx}/product/spec/save','${ctx}/product/spec/add',list_url);
    })
</script>
</body>
</html>