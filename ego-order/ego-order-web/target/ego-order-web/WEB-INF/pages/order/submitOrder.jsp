			...
			<div class="s_hd">
				...
				<%--<div id="s_search">
					<form action="" method="post"><input name="" type="text" class="search-input" />
						<input name="" type="image" src="${ctx}/images/btn_search.jpg" /></form>
				</div>--%>
				...
				<div id="s_cart">
					<ul>
						<li class="nums">
							<a href="javascript:void(0)" id="s_cart_nums1">购物车： <span>0</span>  件</a>
							<a href="javascript:void(0)" class="btn" id="s_cart_nums2"></a></li>
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="osuccess">
				...
				<div class="ddinfo">
					订单编号：1011757885 <a class="blue" href="#">查看订单详情</a><br />付款方式：在线支持 支付宝<br />应付金额：<strong class="red">￥${totalPrice}</strong>
				</div>
				<p class="gopay"><a href="#"><img src="${ctx}/images/gopay.gif" width="88" height="36" alt="" /></a></p>
