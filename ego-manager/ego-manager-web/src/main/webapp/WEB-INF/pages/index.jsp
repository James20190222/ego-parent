	      ...
	      <li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<li onclick="makecss(this)" data-id="categoryList_Goods">
	            		...
	            		<a href='${ctx}/product/type/list' target='rightContent'><i class="fa fa-circle-o"></i>商品模型</a>
	            	</li><li onclick="makecss(this)" data-id="specList_Goods">
	            		<a href='${ctx}/product/spec/list/0' target='rightContent'><i class="fa fa-circle-o"></i>商品规格</a>
	            	</li><li onclick="makecss(this)" data-id="goodsAttributeList_Goods">
	            		<a href='${ctx}/product/attribute/list/0' target='rightContent'><i class="fa fa-circle-o"></i>商品属性</a>
