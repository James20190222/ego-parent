...
<div id="doc">
    ...
    <div id="s_bdw">
        <div id="s_bd">
            ...
            <div class="cartlist">
                <form action="${ctx}/order/toPreOrder" method="post">
                <table width="100%">
                    <thead>
                        <tr>
                            <th>购物车中的商品</th>
                    ...
                    <tbody id="cartBody">
                        <c:forEach var="cart" items="${cartList.goodsVoList}">
                            <tr bgcolor="#fffaf1">
                                ...
                                <td>
                                    ...
                                    <div class="addinput">
                                        <input type="text" name="qty_item_${cart.goodsId}" value="${cart.goodsNum}"
                                               ...
                                               onfocus="getOldGoodsNum('#qty_goodsNum_${cart.goodsId}',this.value);" class="stext"/>
                                ...
                                <td><a href="javascript:void(0)" onclick="deleteCart(this,'${cart.goodsId}','${cart.goodsNum}','${cart.marketPrice}')" class="blue">删除</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    ...
                    <tr>
                        <td valign="top"><a href="javascript:void(0)" onclick="clearCart()"><img src="${ctx}/images/deleteicon.gif"/> 清空购物车</a></td>
                ...
                var setAmount = {
                    ...
                    amount: function (obj, mode) {
                        ...
                        if (this.reg(x)) {
                            ...
                            if (!mode) {
                                ...
                                //变更总价
                                totalPrice=(parseFloat(totalPrice) - parseFloat(marketPrice)).toFixed(2);
                    ...
                    modify: function (obj) {
                        ...
                        if (x < this.min || x > this.max || !this.reg(x)) {
                            ...
                            //获取总价
                            var totalPrice = $("#totalPrice").text();
                            totalPrice=(parseFloat(totalPrice) + parseFloat(marketPrice) * num).toFixed(2);
                            $("#totalPrice").text(totalPrice);
                            //同步至redis
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if(200==result.code){
                                ...
                                //变更总价格
                                $("#totalPrice").text((parseFloat($("#totalPrice").text())-parseFloat(marketPrice)*parseInt(goodsNum)).toFixed(2));
                                layer.msg("删除商品成功！");
                            }else {
                                layer.alert("亲,系统正在升级中,请稍后再试!");
                            }
