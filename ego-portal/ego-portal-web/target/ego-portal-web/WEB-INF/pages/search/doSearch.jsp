...
<script type="template" id="goodsTemplate">
    ...
    <it.length;i++){}}
    <li>
        <input type="hidden" id="" value="{{=it[i].goodsId}}">
        ...
        <dl>
            ...
            <dd><a class="addcat" href="javascript:void(0);"
                   onclick="addToCart('{{=it[i].goodsId}}','{{=it[i].goodsName}}','{{=it[i].originalImg}}','{{=it[i].marketPrice}}')">加入购物车</a></dd>
        </dl>
    </li>
    {{}}}
</script>
...
<script type="template" id="pageTemp">
    <div class="f-r pagination">
        ...
        {{}}}
        <div class="yepage">
            到第<input class="stext" type="text" name="" id="pageBtn" value="" />页
            <input class="btnimg" type="submit" name="" id="" value="" onclick="doSearch()"/>
        </div>
...
<script type="text/javascript">
    ...
    function doSearch(pageNum=1,pageSize=12) {
        ...
        var toPageNum=$("#toPageNumInput").val();
        $("#toPageNum").val(toPageNum);
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.result.length > 0) {
                    //加载模板
                    var temp = doT.template($("#goodsTemplate").text());
                    //数据渲染
                    $("#goodsContent").html(temp(result.result));
