            ...
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a href="${ctx}/product/category/list" data-toggle="tooltip" title=""
                               class="btn btn-default" data-original-title="返回">
                    ...
                    <form  method="post" class="form-horizontal"
                          id="category_form">
                        <input type="text" id="id" name="id" value="${gc.id}">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="parentId" id="parentId" value="${gc.parentId}">
                                <input type="text" name="level" id="level" value="${gc.level}">
                                ...
                                <div class="col-sm-3">
                                    <select name="parent_id_2" id="parent_id_2" class="small form-control" onchange="setParentIdAndLevel(this.value);">
                                        <option value="0">请选择商品分类</option>
                                        <c:forEach var="gc2" items="${gcList2}">
                                            <option <c:if test="${gc2.id==gc.parentId}">selected</c:if> value="${gc2.id}">${gc2.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <image id="oldImage" src="${gc.image}" style="height: 50px; width:70px"/>
                                </div>
                            </div>
...
<script>
    ...
    function get_category(parentId, nextId) {
        ...
        $.ajax({
            url: "${ctx}/product/category/byParentId",
            type: "post",
